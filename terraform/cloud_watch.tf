      ...
      "widgets" : [
        ...
        },
        {
          ...
          "properties" : {
            ...
            "stacked" : true,
            "metrics" : [
              ["AWS/ElasticBeanstalk", "ApplicationRequestsTotal", "EnvironmentName", "flaskbb-environment", { "region" : "us-west-1" }],
              ["AWS/ElasticBeanstalk", "ApplicationRequests2xx", "EnvironmentName", "flaskbb-environment", { "region" : "us-west-1" }],
              ["AWS/ElasticBeanstalk", "ApplicationRequests3xx", "EnvironmentName", "flaskbb-environment", { "region" : "us-west-1" }],
              ["AWS/ElasticBeanstalk", "ApplicationRequests4xx", "EnvironmentName", "flaskbb-environment", { "region" : "us-west-1" }],
